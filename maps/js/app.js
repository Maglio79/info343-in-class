...
var mapboxTiles = {
    accessToken: "pk.eyJ1IjoiY2hyaXNtNzkiLCJhIjoiY2l2bW9scDRqMGJ0NDJ6bzZteWg5NHhlaCJ9.yGdnYoTFxZFn-A8urviJ7A",
...
L.tileLayer(mapboxTiles.url, {
    ...
    style: mapboxTiles.styles.pirates,
...
fetch(seattle911API)
    ...
    .then(function(data) {
        ...
        data.forEach(function(record) {
            ...
            var html = "<h3>" + record.type + "</h3>" + "<p>" + record.address + "</p>";
